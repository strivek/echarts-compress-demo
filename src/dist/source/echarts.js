...
define('zrender/zrender', [
    ...
    var theme = {
        ...
        tooltip: {
            ...
            hideDelay: 100,
            transitionDuration: 0.4,
            backgroundColor: 'rgba(3,98,116,0.2)',
            borderColor: '#333',
            borderRadius: 1,
            borderWidth: 0,
            padding: 10,
        ...
        dataZoom: {
            ...
            backgroundColor: 'rgba(0,0,0,0)',
            dataBackgroundColor: '#eee',
            fillerColor: 'rgba(3,98,116,0.2)',
            handleColor: 'rgba(108,195,183,0.8)'
        },
        grid: {
            x: 100,
            y: 70,
        ...
        map: {
            ...
            itemStyle: {
                normal: {
                    ...
                    label: {
                        show: false,
                        textStyle: { color: 'rgba(139,69,19,1)' }
                    }
                },
                emphasis: {
                    borderColor: 'rgba(0,0,0,0)',
                    borderWidth: 1,
                    areaStyle: { color: 'rgba(223,69,67,0.8)' },
                    label: {
                        show: false,
                        textStyle: { color: 'rgba(139,69,19,1)' }
                    }

...
define(function () {
    var theme = {
        ...
        // 默认色板
        color: ['#6cc3b7', '#df4543', '#eab018', '#a0cd6d', '#036274',
        ...
        toolbox: {
            ...
            y: 'top',                  // 垂直安放位置，默认为全图顶端，可选为：
                                       // 'top' ¦ 'bottom' ¦ 'center'
                                       // ¦ {number}（y坐标，单位px）
            color: ['#6cc3b7', '#df4543', '#eab018', '#5a71c4'],
        ...
        tooltip: {
            ...
            backgroundColor: 'rgba(3,98,116,0.2)',     // 提示背景颜色，默认为透明度为0.7的黑色
            borderColor: '#333',       // 提示边框颜色
            borderRadius: 1,           // 提示边框圆角，单位px，默认为4
        ...
        dataZoom: {
            ...
            fillerColor: 'rgba(3,98,116,0.2)',   // 填充颜色
            handleColor: 'rgba(108,195,183,0.8)'     // 手柄颜色
        },
        ...
        polar: {
            ...
            splitArea: {
                show: true,
                areaStyle: {
                    color: ['rgba(0,0,0,0)', 'rgba(200,200,200,0)']
                }
            },
            splitLine: {
                show: true,
        ...
        k: {
            ...
            itemStyle: {
                normal: {
                    color: '#040a24',          // 阳线填充颜色
                    color0: '#040a24',      // 阴线填充颜色
                    lineStyle: {
                        width: 1,
                        color: '#df4543',   // 阳线边框颜色
                        color0: '#6cc3b7'   // 阴线边框颜色
                    }
                },
                emphasis: {
                    // color: 各异,
